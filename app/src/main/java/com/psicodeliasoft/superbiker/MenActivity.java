...
import com.psicodeliasoft.superbiker.databinding.ActivityMenBinding;

public class MenActivity extends AppCompatActivity {
    // Remove the below line after defining your own ad unit ID.
    private static final String TOAST_TEXT = "Test ads are being shown. "
            + "To show live ads, replace the ad unit ID in res/values/strings.xml with your own ad unit ID.";
    private static final String TAG = "MenActivity";
    ...
    private ActivityMenBinding binding;
        ...
        InterstitialAd.load(this, getString(R.string.interstitial_ad_unit_id), adRequest,
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        Toast.makeText(MenActivity.this, "onAdLoaded()", Toast.LENGTH_SHORT).show();
